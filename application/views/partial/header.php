...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo $this->config->item('company') . ' -- ' . $this->lang->line('common_powered_by') . ' Eranda' ?></title>
        ...
        <div id="menubar">
            <div id="menubar_container">
                <div id="menubar_company_info">
                    ...
                    <span style='font-size:8pt;'><?php echo $this->lang->line('common_powered_by') . ' Eranda Bandaranaike'; ?></span>
                </div>
